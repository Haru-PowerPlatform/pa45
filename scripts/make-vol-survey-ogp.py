...
VOL_TEXT = {
    ...
    24: {
        "title": "スタンプを押すだけで、\n出欠は集まったか？",
        "sub": "Teamsの絵文字リアクションをきっかけにして、出欠を自動で集計する回。",
        "quote": "「これまで使ったことのないアクションを知ることができ、勉強になりました」",
    },
    25: {
        "title": "メールの添付は、\n勝手に片づいたか？",
        "sub": "届いた添付をSharePointの月フォルダへ自動保存し、元メールに印をつける回。",
        "quote": "「メールに『保存済み』と表示できるため、保存状況の確認にも役立つと思いました」",
    },
    26: {
        "title": "報連相は、\nボタン1つになったか？",
        "sub": "毎日16時に届くTeamsカードを3択でタップ。記録も上司への一報も自動で回る回。",
        "quote": "「Adaptive Cardは回答もしやすくていいなと感じました」",
    },
    27: {
        "title": "Copilotに、\n何を渡せば当たるのか？",
        "sub": "前回つくったフローを題材に、スクショ・実行履歴・ZIPの中身を渡し分ける回。",
        "quote": "「日本語での指示方法やZIPファイルの活用方法は初めて知り、参考になりました」",
    },
    28: {
        "title": "チェックした分だけ、\nまとめて完了になったか？",
        "sub": "やること3件を1枚のカードに出し、返ってきた答えで完了に更新する回。",
        "quote": "「やってみたかった内容そのものでした。早速試してみます。」",
    },
}
