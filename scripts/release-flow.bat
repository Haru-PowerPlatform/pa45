...
if "%VOL%"=="11" set SOLUTION=PA45No11RunHistory
...
for %%S in (PA45No1Initialize PA45No2SetVariable PA45No3Condition PA45No4ApplyToEach PA45No5Review PA45No6FormsMail PA45No7FormsSPTeams PA45No8Approval PA45No9SharePointUpdate PA45No10BizReview PA45No11RunHistory) do (
    echo.
    echo --- %%S ---
