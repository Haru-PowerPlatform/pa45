...
6. **Cドライブのファイル・フォルダパスは必ずクリッカブルリンクで表示する**。ファイルは `[file.png](file:///C:/Temp/file.png)`、フォルダは `[📁 C:\Temp](file:///C:/Temp)` の形式で書く。
...
| 7 | 2026-04-24 | 391355 | Formsの申請をSharePointに自動登録して担当者に通知しよう | - |
